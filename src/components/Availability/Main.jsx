...
//                           <BoxFn onClick={() => foo(innerItem.modalDates, innerItem.app_name, innerItem.flow_name)}>
...
//           <Box sx={{ width: "98%", height: "50%", background: "#fff", padding: "0 20px", borderRadius: "5px" }} >
//             <h1>App Name: {modalAppNameVar}</h1>
//             <h1>Flow Name: {modalFlowNameVar}</h1>
//           <Box sx={{ width: "100%", height: "50%", display: "flex", justifyContent: "space-around", alignItems: "center", flexWrap: "wrap" }}>
//             {newAveraveData.slice(0, 120).map((item, i) => {
//               return (
//                 <Box key={i}>
//                   <Tooltip title={`${item.slice(0, 19)}`} arrow> {item == "No data available" ? <GrayBars /> : <GreenBars />} </Tooltip>
//                 </Box>
//               );
//             })}
//           </Box>
